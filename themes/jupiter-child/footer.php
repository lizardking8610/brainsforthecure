...
<div class="bftc-footer-form-container">
<h3>Sign up to receive additional information.</h3>
<?php echo do_shortcode( '[contact-form-7 id="587" title="Footer Form"]' ); ?>
</div>
...
jQuery(window).on('load', function($) {
    jQuery('#menu-navigation').removeClass('dropdownJavascript');
});
</script>
</footer>  
</body>
