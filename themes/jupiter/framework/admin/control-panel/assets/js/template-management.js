var mk_template_count_per_request = 10,
    ...
    mk_install_types = ['backup_db' , 'reset_db', 'upload', 'unzip', 'validate', 'plugin', 'theme_content', 'menu_locations', 'setup_pages', 'theme_options', 'theme_widget', 'finilize'],
...
(function($) {
    ...
    $(document).on('click', '.sweet-alert input[type="text"]', function() {
        $(this).select();
    });
