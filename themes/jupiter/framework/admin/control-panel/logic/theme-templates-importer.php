...
<div class="wp-install-template cp-pane">
	...
	?>
			...
			<div class="template-uploader">
				...
				<ol>
					<li><strong><?php printf( __( 'Select and <a href="%s" target="_blank">Download</a> your desired template.', 'mk_framework' ), 'https://themes.artbees.net/template/' ); ?></strong></li>
		...
		<?php
				...
				echo mk_get_control_panel_view('permission-error', true, array('message' => 'In order to install new templates you must set right permission on upload directory.<br> <a target="_blank" href="https://themes.artbees.net/docs/template-errors/">Learn More</a>'));
			}
		}else{
    		echo mk_get_control_panel_view('register-product-popup', true, array('message' => 'In order to install new templates you must register theme.<br><a target="_blank" href="https://themes.artbees.net/docs/how-to-register-theme/">Learn how to register</a>'));
		}
		?>
...
<!-- Files will be placed here -->
		...
		<hr/>
		<div class="how-to">
			<strong><?php printf( __( 'Any problem? <a href="%s" target="_blank"><strong>View the tutorial here</strong></a>', 'mk_framework' ), 'https://themes.artbees.net/docs/how-to-register-theme/' ); ?></strong>
