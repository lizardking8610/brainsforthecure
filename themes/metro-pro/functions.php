...
function metro_enqueue_scripts() {
	...
	// Load scripts only if custom backstretch image is being used.
            wp_enqueue_script( 'metro-pro-backstretch-set', get_stylesheet_directory_uri() . '/js/backstretch-set.js' , array( 'jquery', 'metro-pro-backstretch' ), '1.0.0', true );

	if ( ! empty( $image ) ) {

		wp_enqueue_script( 'metro-pro-backstretch', get_stylesheet_directory_uri() . '/js/backstretch.js', array( 'jquery' ), '1.0.0', true );
