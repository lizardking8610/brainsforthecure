<div class="dd-layouts-wrap">
    ...
    <div id="iconwrap" class="js-layouts-icon-wrap">
        <img src="<?php echo WPDDL_RES_RELPATH;?>/images/<?php echo $icon_object->icon;?>" class="js-layouts-icon layouts-icon" data-tooltip-content="<?php echo $icon_object->text; ?>" data-tooltip-header="<?php echo $icon_object->header; ?>" />
    </div>
...
<div class="ddl-video-private-container">
